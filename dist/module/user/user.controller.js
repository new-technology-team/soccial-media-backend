...
let UserController = class UserController {
    ...
    aiSupport(body) {
        ...
        return {
            ...
            data: {
                original: input,
                suggestion: 'Bạn có thể kiểm tra lại từ khóa tìm kiếm, trạng thái kết nối và quyền truy cập tài khoản trước khi thao tác.',
            },
        };
    }
};
...
__decorate([
    (0, common_1.Post)('ai/support'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "aiSupport", null);
