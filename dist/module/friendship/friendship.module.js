...
exports.FriendshipModule = FriendshipModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([friendship_entity_1.Friendship], 'mariadb'), user_module_1.UserModule, notification_module_1.NotificationModule],
        controllers: [friendship_controller_1.FriendshipController],
        providers: [friendship_service_1.FriendshipService],
        exports: [friendship_service_1.FriendshipService, typeorm_1.TypeOrmModule],
    })
], FriendshipModule);
