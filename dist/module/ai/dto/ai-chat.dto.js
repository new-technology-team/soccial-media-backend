...
exports.AiChatDto = exports.ChatHistoryEntryDto = void 0;
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
/** Một lượt trong lịch sử hội thoại */
class ChatHistoryEntryDto {
}
exports.ChatHistoryEntryDto = ChatHistoryEntryDto;
__decorate([
    (0, class_validator_1.IsIn)(['user', 'model']),
    __metadata("design:type", String)
], ChatHistoryEntryDto.prototype, "role", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ChatHistoryEntryDto.prototype, "text", void 0);
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => ChatHistoryEntryDto),
